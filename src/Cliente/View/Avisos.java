...
public class Avisos {
    ...
    public String ip(){
        // Muestra un cuadro de diálogo para que el usuario introduzca la dirección IP del servidor
    ...
    public String nick(){
        // Muestra un cuadro de diálogo para que el usuario introduzca su nombre de usuario (nick)
